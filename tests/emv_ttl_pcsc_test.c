...
static const struct xpdu_t test_pcsc_case_1_error[] = {
    {
        4, (uint8_t[]){0x12, 0x34, 0x56, 0x78}, 2,
...
static const struct xpdu_t test_pcsc_case_2_normal[] = {
    ...
    },
    {
        ...
        0x1E,
        (uint8_t[]){0x70, 0x1A, 0x61, 0x18, 0x4F, 0x07, 0xA0, 0x00, 0x00, 0x00,
                    0x03, 0x10, 0x10, 0x50, 0x0A, 0x56, 0x49, 0x53, 0x41, 0x20,
                    0x44, 0x45, 0x42, 0x49, 0x54, 0x87, 0x01, 0x01, 0x90, 0x00},
    },
    {0}};
...
static const struct xpdu_t test_pcsc_case_4_normal[] = {
    {
        20,
        (uint8_t[]){0x00, 0xA4, 0x04, 0x00, 0x0E, 0x31, 0x50,
    ...
    },
    {
        ...
        0x28,
        (uint8_t[]){0x6F, 0x24, 0x84, 0x0E, 0x31, 0x50, 0x41, 0x59, 0x2E, 0x53,
                    0x59, 0x53, 0x2E, 0x44, 0x44, 0x46, 0x30, 0x31, 0xA5, 0x12,
                    0x88, 0x01, 0x01, 0x5F, 0x2D, 0x08, 0x65, 0x6E, 0x65, 0x73,
                    0x66, 0x72, 0x64, 0x65, 0x9F, 0x11, 0x01, 0x01, 0x90, 0x00},
    },
    {0}};
...
static const struct xpdu_t test_pcsc_case_2_normal_advanced[] = {
    ...
    },
    {
        ...
        0x0F,
        (uint8_t[]){0x70, 0x1A, 0x61, 0x18, 0x4F, 0x07, 0xA0, 0x00, 0x00, 0x00,
                    0x03, 0x10, 0x10, 0x61, 0x0F},
    },
    {
        5,
        (uint8_t[]){0x00, 0xC0, 0x00, 0x00, 0x0F},
        0x11,
        (uint8_t[]){0x50, 0x0A, 0x56, 0x49, 0x53, 0x41, 0x20, 0x44, 0x45, 0x42,
...
static const struct xpdu_t test_pcsc_case_4_normal_advanced[] = {
    ...
    },
    {
        ...
        0x11,
        (uint8_t[]){0x6F, 0x24, 0x84, 0x0E, 0x31, 0x50, 0x41, 0x59, 0x2E, 0x53,
                    0x59, 0x53, 0x2E, 0x44, 0x44, 0x61, 0x14},
    },
    {
        5,
        (uint8_t[]){0x00, 0xC0, 0x00, 0x00, 0x14},
        0x19,
        (uint8_t[]){0x46, 0x30, 0x31, 0xA5, 0x12, 0x88, 0x01, 0x01, 0x5F,
                    0x2D, 0x08, 0x65, 0x6E, 0x65, 0x73, 0x66, 0x72, 0x64,
                    0x65, 0x9F, 0x11, 0x01, 0x01, 0x90, 0x00},
    },
    {0}};
...
static const struct xpdu_t test_pcsc_case_4_warning2[] = {
    ...
    {
        5, (uint8_t[]){0x00, 0xC0, 0x00, 0x00, 0x26}, 0x28,
        (uint8_t[]){0x6F, 0x24, 0x84, 0x0E, 0x31, 0x50, 0x41, 0x59, 0x2E,
                    0x53, 0x59, 0x53, 0x2E, 0x44, 0x44, 0x46, 0x30, 0x31,
                    0xA5, 0x12, 0x88, 0x01, 0x01, 0x5F, 0x2D, 0x08, 0x65,
                    0x6E, 0x65, 0x73, 0x66, 0x72, 0x64, 0x65, 0x9F, 0x11,
                    0x01, 0x01, 0x62, 0x86}, // No input available from a sensor
                                             // on the card
    },
    {0}};
...
int main(void) {
  ...
  // bytes)
  printf("\nTesting APDU case 2 (PC/SC mode); normal processing (using both "
  ...
  printf("\nTesting APDU case 4 (PC/SC mode); normal processing (using "
         "multiple '61' procedure bytes)...\n");
  ...
  printf("\nTesting APDU case 4 (PC/SC mode); warning processing ('62' then "
         "'6C')...\n");
  ...
  printf("\nTesting APDU case 4 (PC/SC mode); warning processing ('61' then "
         "'62')...\n");

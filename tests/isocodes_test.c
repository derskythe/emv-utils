...
int main(void) {
  ...
  printf("%s\n", dgettext("iso_3166-3",
                          "710")); // Cannot resolve numeric codes via libintl
#endif
  ...
  if (strcmp(country, "Netherlands") != 0) {
    fprintf(
        stderr,
        "isocodes_lookup_country_by_alpha2() found unexpected country '%s'\n",
        country);
    return 1;
  }
  ...
  if (strcmp(country, "Netherlands") != 0) {
    fprintf(
        stderr,
        "isocodes_lookup_country_by_alpha3() found unexpected country '%s'\n",
        country);
    return 1;
  }
  ...
  if (strcmp(country, "Netherlands") != 0) {
    fprintf(
        stderr,
        "isocodes_lookup_country_by_numeric() found unexpected country '%s'\n",
        country);
    return 1;
  }
  ...
  if (strcmp(currency, "Euro") != 0) {
    fprintf(
        stderr,
        "isocodes_lookup_currency_by_alpha3() found unexpected currency '%s'\n",
        currency);
    return 1;
  }
  ...
  if (strcmp(currency, "Euro") != 0) {
    fprintf(stderr,
            "isocodes_lookup_currency_by_numeric() found unexpected currency "
            "'%s'\n",
            currency);
    return 1;
  }
  ...
  if (strcmp(language, "French") != 0) {
    fprintf(
        stderr,
        "isocodes_lookup_language_by_alpha2() found unexpected language '%s'\n",
        language);
    return 1;
  }
  ...
  if (strcmp(language, "Northern Frisian") != 0) {
    fprintf(
        stderr,
        "isocodes_lookup_language_by_alpha3() found unexpected language '%s'\n",
        language);
    return 1;
  }

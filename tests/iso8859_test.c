...
static const char *utf8_verify[] = {
    "",
    u8" ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæç"
    u8"èéêëìíîïðñòóôõö÷øùúûüýþÿ",
    u8" Ą˘Ł¤ĽŚ§¨ŠŞŤŹ­ŽŻ°ą˛ł´ľśˇ¸šşťź˝žżŔÁÂĂÄĹĆÇČÉĘËĚÍÎĎĐŃŇÓÔŐÖ×ŘŮÚŰÜÝŢßŕáâăäĺćç"
    u8"čéęëěíîďđńňóôőö÷řůúűüýţ˙",
    u8" Ħ˘£¤Ĥ§¨İŞĞĴ­Ż°ħ²³´µĥ·¸ışğĵ½żÀÁÂÄĊĈÇÈÉÊËÌÍÎÏÑÒÓÔĠÖ×ĜÙÚÛÜŬŜßàáâäċĉçèéêëìí"
    u8"îïñòóôġö÷ĝùúûüŭŝ˙",
    u8" ĄĸŖ¤ĨĻ§¨ŠĒĢŦ­Ž¯°ą˛ŗ´ĩļˇ¸šēģŧŊžŋĀÁÂÃÄÅÆĮČÉĘËĖÍÎĪĐŅŌĶÔÕÖ×ØŲÚÛÜŨŪßāáâãäåæį"
    u8"čéęëėíîīđņōķôõö÷øųúûüũū˙",
    u8" ЁЂЃЄЅІЇЈЉЊЋЌ­ЎЏАБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдежзийклмнопрстуфхцч"
    u8"шщъыьэюя№ёђѓєѕіїјљњћќ§ўџ",
    u8" ¤،­؛؟ءآأؤإئابةتثجحخدذرزسشصضطظعغـفقكلمنهوىيًٌٍَُِّْ",
    u8" ‘’£€₯¦§¨©ͺ«¬­―°±²³΄΅Ά·ΈΉΊ»Ό½ΎΏΐΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΤΥΦΧΨΩΪΫάέήίΰαβγδεζηθι"
    u8"κλμνξοπρςστυφχψωϊϋόύώ",
    u8" ¢£¤¥¦§¨©×«¬­®¯°±²³´µ¶·¸¹÷»¼½¾‗אבגדהוזחטיךכלםמןנסעףפץצקרשת"
    u8"‎"
    u8"‏",
    u8" ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏĞÑÒÓÔÕÖ×ØÙÚÛÜİŞßàáâãäåæç"
    u8"èéêëìíîïğñòóôõö÷øùúûüışÿ",
    u8" ĄĒĢĪĨĶ§ĻĐŠŦŽ­ŪŊ°ąēģīĩķ·ļđšŧž―ūŋĀÁÂÃÄÅÆĮČÉĘËĖÍÎÏÐŅŌÓÔÕÖŨØŲÚÛÜÝÞßāáâãäåæį"
    u8"čéęëėíîïðņōóôõöũøųúûüýþĸ",
    ...
    u8" ”¢£¤„¦§Ø©Ŗ«¬­®Æ°±²³“µ¶·ø¹ŗ»¼½¾æĄĮĀĆÄÅĘĒČÉŹĖĢĶĪĻŠŃŅÓŌÕÖ×ŲŁŚŪÜŻŽßąįāćäåęē"
    u8"čéźėģķīļšńņóōõö÷ųłśūüżž’",
    u8" Ḃḃ£ĊċḊ§Ẁ©ẂḋỲ­®ŸḞḟĠġṀṁ¶ṖẁṗẃṠỳẄẅṡÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏŴÑÒÓÔÕÖṪØÙÚÛÜÝŶßàáâãäåæç"
    u8"èéêëìíîïŵñòóôõöṫøùúûüýŷÿ",
    u8" ¡¢£€¥Š§š©ª«¬­®¯°±²³Žµ¶·ž¹º»ŒœŸ¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæç"
    u8"èéêëìíîïðñòóôõö÷øùúûüýþÿ",
...
int main(void) {
  ...
  for (unsigned int codepage = 1; codepage <= codepage_max; ++codepage) {
    ...
    for (size_t i = 0xA0; i <= 0xFF; ++i) {
      ...
      if ((codepage == 3 && (i == 0xA5 || i == 0xAE || i == 0xBE || i == 0xC3 ||
                             i == 0xD0 || i == 0xE3 || i == 0xF0)) ||
          (codepage == 6 && i != 0xA0 && i != 0xA4 && i != 0xAC && i != 0xAD &&
           i != 0xBB && i != 0xBF &&
           (i <= 0xC0 || (i >= 0xDB && i <= 0xDF) || i >= 0xF3)) ||
          (codepage == 7 && (i == 0xAE || i == 0xD2 || i == 0xFF)) ||
          (codepage == 8 && (i == 0xA1 || (i >= 0xBF && i <= 0xDE) ||
                             i == 0xFB || i == 0xFC || i == 0xFF)) ||
    ...
    memset(utf8, 0, sizeof(utf8));
    r = iso8859_to_utf8(codepage, iso8859, iso8859_other_len, utf8,
                        sizeof(utf8));
    if (r) {
      fprintf(stderr, "iso8859_to_utf8() failed; r=%d\n", r);
      return 1;

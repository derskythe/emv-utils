...
int main(void) {
  ...
  printf("\nTesting parsing of \"123456\" as format \"cn\" into 2-byte "
         "buffer...\n");
  ...
  printf("\nTesting parsing of \"123456\" as format \"cn\" into 3-byte "
         "buffer...\n");
  ...
  printf("\nTesting parsing of \"123456\" as format \"cn\" into 4-byte "
         "buffer...\n");
  ...
  printf("\nTesting parsing of \"12345\" as format \"cn\" into 3-byte "
         "buffer...\n");
  memset(buf3, 0x00, sizeof(buf3));
  ...
  printf("\nTesting parsing of \"12345\" as format \"cn\" into 4-byte "
         "buffer...\n");
  memset(buf4, 0x00, sizeof(buf4));
  ...
  printf("\nTesting parsing of \"12B456\" as format \"cn\" into 4-byte "
         "buffer...\n");
  memset(buf4, 0x00, sizeof(buf4));
  ...
  printf("\nTesting parsing of \"123F56\" as format \"cn\" into 4-byte "
         "buffer...\n");
  memset(buf4, 0x00, sizeof(buf4));
  ...
  printf("\nTesting parsing of \"123456A\" as format \"cn\" into 3-byte "
         "buffer...\n");
  memset(buf3, 0x00, sizeof(buf3));
  ...
  printf("\nTesting parsing of \"123456\" as format \"n\" into 2-byte "
         "buffer...\n");
  ...
  printf("\nTesting parsing of \"123456\" as format \"n\" into 3-byte "
         "buffer...\n");
  ...
  printf("\nTesting parsing of \"123456\" as format \"n\" into 4-byte "
         "buffer...\n");
  ...
  printf("\nTesting parsing of \"12B456\" as format \"n\" into 4-byte "
         "buffer...\n");
  memset(buf4, 0x00, sizeof(buf4));
  ...
  printf("\nTesting parsing of \"123F56\" as format \"n\" into 4-byte "
         "buffer...\n");
  memset(buf4, 0x00, sizeof(buf4));
  ...
  printf("\nTesting parsing of \"A123456\" as format \"n\" into 3-byte "
         "buffer...\n");
  memset(buf3, 0x00, sizeof(buf3));
  // NOTE: parser stops when buffer is full and won't reach invalid digit
  ...
  r = emv_format_ans_ccs_get_string(iso8859, sizeof(iso8859), utf8,
                                    sizeof(utf8));
  if (r) {
  ...
  if (utf8[sizeof(utf8) - 1] != 0) {
    fprintf(stderr, "emv_format_ans_ccs_get_string() failed; output buffer not "
                    "NULL terminated\n");
    return 1;
  }
  ...
  if (memcmp(utf8, iso8859, sizeof(utf8) - 1) != 0) {
    fprintf(
        stderr,
        "emv_format_ans_ccs_get_string() failed; incorrect output buffer\n");

...
struct emv_app_t {
   ...
   * - File Control Information (FCI) template (field 6F) provided by
 ...
 * @param pse_dir_entry PSE directory entry (content of Application Template,
 * field 61)
 ...
 * @note This function should not be used to free EMV applications that are
 * elements of a list
 * @param app EMV application to free
 * @return Zero for success. Non-zero if it is unsafe to free the EMV
 * application.
 */
 ...
 * @param list EMV application list
 * @return Boolean indicating whether cardholder application selection is
 * required
 */

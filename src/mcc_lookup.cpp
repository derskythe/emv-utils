...
static bool mcc_map_add(json_object *jso) {
  /* mcc-codes submodule's mcc_codes.json file should have this structure
  {
          [
                  ...
                  {
                          "mcc": "5999",
                          "edited_description": "Miscellaneous and Specialty
  Retail Stores", "combined_description": "Miscellaneous and Specialty Retail
  Stores", "usda_description": "Miscellaneous and Specialty Retail Stores",
...
static bool build_mcc_list(json_object *json_root) noexcept {
  ...
  */
  ...
  r = json_c_visit(json_root, 0, &json_array_visit_userfunc,
                   (void *)&mcc_map_add);
  if (r) {
    return false;
  }

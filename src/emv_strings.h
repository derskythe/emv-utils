 ...
 * zero if iso-codes package not found.
 */
 ...
 * @note @c value_str output will be empty if human readable string is not
 * available
 *
 ...
 * zero for parse error.
 */
int emv_term_type_get_string_list(uint8_t term_type, char *str, size_t str_len);
 ...
 * @note Strings in output buffer are delimited using "\n", including the last
 * string
 * @param addl_term_caps Additional terminal capabilities field. Must be 5
 * bytes.
 * @param addl_term_caps_len Length of additional terminal capabilities field.
 * Must be 5 bytes.
 * @param str String buffer output
 * @param str_len Length of string buffer in bytes
 * @return Zero for success. Less than zero for internal error. Greater than
 ...
 * @param asrpd_len Length of Application Selection Registered Proprietary Data
 * (ASRPD) field.
 * @param str String buffer output
 * @param str_len Length of string buffer in bytes
 * @return Zero for success. Less than zero for internal error. Greater than
 ...
 * @param aip_len Length of Application Interchange Profile (AIP) field. Must be
 * 2 bytes.
 * @param str String buffer output
 * @param str_len Length of string buffer in bytes
 * @return Zero for success. Less than zero for internal error. Greater than
 ...
 * @param auc_len Length of Application Usage Control (AUC) field. Must be 2
 * bytes.
 * @param str String buffer output
 * @param str_len Length of string buffer in bytes
 * @return Zero for success. Less than zero for internal error. Greater than
 ...
 * @note Strings in output buffer are delimited using "\n", including the last
 * string
 * @param arc Application Reference Currency field. Must be multiples of 2
 * bytes.
 * @param arc_len Length of Application Reference Currency field. Must be
 ...
 * @param lp_len Length of Language Preference field. Must be multiples of 2
 * bytes.
 * @param str String buffer output
 * @param str_len Length of string buffer in bytes
 * @return Zero for success. Less than zero for internal error. Greater than
 ...
 * @note Strings in output buffer are delimited using "\n", including the last
 * string
 * @param cvmresults Cardholder Verification Method (CVM) Results field. Must be
 * 3 bytes.
 * @param cvmresults_len Length of Cardholder Verification Method (CVM) Results
 * field. Must be 3 bytes.
 * @param str String buffer output
 * @param str_len Length of string buffer in bytes
 * @return Zero for success. Less than zero for internal error. Greater than
 * zero for parse error.
 ...
 * @param tvr_len Length of Terminal Verification Results (TVR) field. Must be 5
 * bytes.
 * @param str String buffer output
 * @param str_len Length of string buffer in bytes
 * @return Zero for success. Less than zero for internal error. Greater than
 ...
 * @param tsi_len Length of Transaction Status Information (TSI) field. Must be
 * 2 bytes.
 * @param str String buffer output
 * @param str_len Length of string buffer in bytes
 * @return Zero for success. Less than zero for internal error. Greater than
 ...
 * @param trmd_len Length of Terminal Risk Management Data field. Must be 8
 * bytes.
 * @param str String buffer output
 * @param str_len Length of string buffer in bytes
 * @return Zero for success. Less than zero for internal error. Greater than
 ...
 * @param ttq_len Length of Terminal Transaction Qualifiers (TTQ) field. Must be
 * 4 bytes.
 * @param str String buffer output
 * @param str_len Length of string buffer in bytes
 * @return Zero for success. Less than zero for internal error. Greater than
 ...
 * @param ctq_len Length of Card Transaction Qualifiers (CTQ) field. Must be 2
 * bytes.
 * @param str String buffer output
 * @param str_len Length of string buffer in bytes
 * @return Zero for success. Less than zero for internal error. Greater than
 ...
 * @note Strings in output buffer are delimited using "\n", including the last
 * string
 * @param enh_cl_reader_caps Enhanced Contactless Reader Capabilities field.
 * Must be 4 bytes.
 * @param enh_cl_reader_caps_len Length of Enhanced Contactless Reader
 * Capabilities field. Must be 4 bytes.
 * @param str String buffer output
 * @param str_len Length of string buffer in bytes
 * @return Zero for success. Less than zero for internal error. Greater than
 * zero for parse error.
 ...
 * @param iad_len Length of Issuer Authentication Data field. Must be 8 to 16
 * bytes.
 * @param str String buffer output
 * @param str_len Length of string buffer in bytes
 * @return Zero for success. Less than zero for internal error. Greater than
 ...
 * @param c_apdu Command Application Protocol Data Unit (C-APDU). Must be at
 * least 4 bytes.
